...
\begin{frame}{Почему можно уеньшить размероность?}{В конструктивной постановке}
Датчики могут:
\begin{itemize}
...
\begin{frame}{Почему можно уеньшить размероность?}{В случае сырых данных}
...
\small
У подобной постоновки есть несколько свойств:
\begin{itemize}
  ...
  \item считаем, что проверяемый фактор не влияет на это расперделение;
...
В CV обычно втает вопрос соотвношения мощности $L$ и $V$. Есть две альтернативы:
\begin{itemize}
...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item поняли как все там на ладан дышет;
